        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">${{ number_format($stats['total_sent'], 2) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">${{ number_format($stats['total_received'], 2) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Download Transaction Report</h3>
                </div>
                <div class="p-6">
                    <a href="{{ route('transactions.download') }}" 
                       class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-lg">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @else
                    <div class="p-6 text-center">
                        ...
                        <p class="text-xs text-gray-400">Your transaction history will appear here once you make transfers</p>
                    </div>
                @endif
            </div>
        </div>
