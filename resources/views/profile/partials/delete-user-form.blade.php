<section class="space-y-6">
    ...
    <div class="bg-red-50 border border-red-200 rounded-lg p-4">
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-red-800">Permanent Action</h3>
                <div class="mt-2 text-sm text-red-700">
                    <p>This action cannot be undone. All your account data, transactions, and balance will be permanently deleted.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        name="password"
                        type="password"
                        class="pl-10 block w-full border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500"
