                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <p>You are logged in as an administrator. <a href="{{ route('admin.dashboard') }}" class="font-medium underline hover:text-blue-600">Go to Admin Dashboard</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Here's your banking overview</p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold mt-1">${{ number_format(Auth::user()->balance, 2) }}</p>
                            <p class="text-blue-100 text-sm mt-2">Account: {{ Auth::user()->email }}</p>
                        </div>
                        <div class="text-right">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500">Transfer to other users</p>
                        </div>
                    </div>
                    <div class="mt-4">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500">View your recent activity</p>
                        </div>
                    </div>
                    <div class="mt-4">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-gray-900">Support Chat</h3>
                            <p class="text-sm text-gray-500">Get help from support</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('conversations.index') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            Contact Support
                        </a>
                    </div>
                </div>
